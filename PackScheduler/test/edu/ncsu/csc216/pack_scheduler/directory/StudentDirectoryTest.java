...
public class StudentDirectoryTest {
	...
	/**
	 * Tests addStudent with invalid password
	 */
	@Test
	...
	/**
	 * Tests the addStudent method with invalid max credits
	 */
	@Test
	public void testAddStudentInvalidMaxCredits() {
		StudentDirectory sd = new StudentDirectory();
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, 20));
	}
